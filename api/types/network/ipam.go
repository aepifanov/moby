...
type IPAMState struct {
	Subnet  string `json:",omitempty"`
	IPRange string `json:",omitempty"`
	// Counter of available IPs in the subnet
	AvailableAddressSubnet uint64 `json:",omitempty"`
	// Counter of available IPs in the allocation pool
	AvailableAddressIPRange uint64 `json:",omitempty"`
}
