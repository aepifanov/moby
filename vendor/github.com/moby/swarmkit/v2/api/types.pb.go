...
func (PortConfig_Protocol) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{28, 0}
}
...
func (PortConfig_PublishMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{28, 1}
}
...
func (ExternalCA_CAProtocol) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{35, 0}
}
...
func (EncryptionKey_Algorithm) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{48, 0}
}
...
func (Privileges_SeccompOpts_SeccompMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{58, 2, 0}
}
...
func (Privileges_AppArmorOpts_AppArmorMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{58, 3, 0}
}
...
func (VolumeAccessMode_Sharing) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{60, 1}
}
...
func (VolumePublishStatus_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{62, 0}
}
...
func (VolumeCapability_AccessMode_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{69, 2, 0}
}
...
type IPAMState struct {
	...
	SubnetAllocated uint64 `protobuf:"varint,3,opt,name=subnet_allocated,json=subnetAllocated,proto3" json:"subnet_allocated,omitempty"`
	// Counter of allocated IPs in the allocation pool
	RangeAllocated uint64 `protobuf:"varint,4,opt,name=range_allocated,json=rangeAllocated,proto3" json:"range_allocated,omitempty"`
}

func (m *IPAMState) Reset()      { *m = IPAMState{} }
func (*IPAMState) ProtoMessage() {}
func (*IPAMState) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{26}
}
func (m *IPAMState) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IPAMState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IPAMState.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IPAMState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IPAMState.Merge(m, src)
}
func (m *IPAMState) XXX_Size() int {
	return m.Size()
}
func (m *IPAMState) XXX_DiscardUnknown() {
	xxx_messageInfo_IPAMState.DiscardUnknown(m)
}

var xxx_messageInfo_IPAMState proto.InternalMessageInfo
...
type NetworkState struct {
	...
	IPAM []*IPAMState `protobuf:"bytes,1,rep,name=ipam,proto3" json:"ipam,omitempty"`
}
...
func (*AcceptancePolicy_RoleAdmissionPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{34, 0}
}
...
func (*AcceptancePolicy_RoleAdmissionPolicy_Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{34, 0, 0}
}
...
func (*Privileges_SeccompOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{58, 2}
}
...
func (*Privileges_AppArmorOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{58, 3}
}
...
func (*Topology) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{68}
}
...
func (*VolumeCapability) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{69}
}
...
func (*VolumeCapability_BlockVolume) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{69, 0}
}
...
func (*VolumeCapability_MountVolume) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{69, 1}
}
...
func (*VolumeCapability_AccessMode) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5eafd0404ded3d, []int{69, 2}
}
...
func init() {
	...
	proto.RegisterType((*IPAMState)(nil), "docker.swarmkit.v1.IPAMState")
	proto.RegisterType((*NetworkState)(nil), "docker.swarmkit.v1.NetworkState")
...
var fileDescriptor_0b5eafd0404ded3d = []byte{
	...
	,
}
...
func (m *IPAMState) Copy() *IPAMState {
	if m == nil {
		return nil
	}
	o := &IPAMState{}
...
func (m *IPAMState) CopyFrom(src interface{}) {

	o := src.(*IPAMState)
	*m = *o
}

func (m *NetworkState) Copy() *NetworkState {
	if m == nil {
		return nil
	}
	o := &NetworkState{}
...
func (m *NetworkState) CopyFrom(src interface{}) {

	o := src.(*NetworkState)
	*m = *o
	if o.IPAM != nil {
		m.IPAM = make([]*IPAMState, len(o.IPAM))
		for i := range m.IPAM {
			m.IPAM[i] = &IPAMState{}
			github_com_moby_swarmkit_v2_api_deepcopy.Copy(m.IPAM[i], o.IPAM[i])
		}
	}
...
func (m *IPAMState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IPAMState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IPAMState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.RangeAllocated != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.RangeAllocated))
		i--
		dAtA[i] = 0x20
	}
	if m.SubnetAllocated != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.SubnetAllocated))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Range) > 0 {
...
func (m *NetworkState) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NetworkState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NetworkState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.IPAM) > 0 {
		for iNdEx := len(m.IPAM) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.IPAM[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *IPAMState) Size() (n int) {
	...
	if m.SubnetAllocated != 0 {
		n += 1 + sovTypes(uint64(m.SubnetAllocated))
	}
	if m.RangeAllocated != 0 {
		n += 1 + sovTypes(uint64(m.RangeAllocated))
	}
	return n
}

func (m *NetworkState) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *IPAMState) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IPAMState{`,
		`Subnet:` + fmt.Sprintf("%v", this.Subnet) + `,`,
		`Range:` + fmt.Sprintf("%v", this.Range) + `,`,
		`SubnetAllocated:` + fmt.Sprintf("%v", this.SubnetAllocated) + `,`,
		`RangeAllocated:` + fmt.Sprintf("%v", this.RangeAllocated) + `,`,
		`}`,
	}, "")
	return s
}
func (this *NetworkState) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForIPAM := "[]*IPAMState{"
	for _, f := range this.IPAM {
		repeatedStringForIPAM += strings.Replace(f.String(), "IPAMState", "IPAMState", 1) + ","
	}
	repeatedStringForIPAM += "}"
	s := strings.Join([]string{`&NetworkState{`,
		`IPAM:` + repeatedStringForIPAM + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *IPAMState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IPAMState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IPAMState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubnetAllocated", wireType)
			}
			m.SubnetAllocated = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SubnetAllocated |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RangeAllocated", wireType)
			}
			m.RangeAllocated = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RangeAllocated |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *NetworkState) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NetworkState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NetworkState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.IPAM = append(m.IPAM, &IPAMState{})
			if err := m.IPAM[len(m.IPAM)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
